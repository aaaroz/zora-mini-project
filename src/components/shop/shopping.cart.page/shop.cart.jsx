        ...
        {products?.length !== 0 ? (
          <>
            ...
            <div className="mt-8 mx-2 md:mx-24 capitalize font-medium text-sm md:text-lg md:flex md:justify-between">
              ...
              <p>
                total price :{" "}
                <span className="font-bold">${stateTotalPrice}</span>
              </p>
            </div>
            <ModalOrder
          ...
          <div className="flex flex-col items-center  h-[30rem]">
            <span className="text-9xl mt-10">
              <HiOutlineShoppingCart />
            </span>
            <p className="text-3xl mt-5 capitalize">
              There's no product in your shopping cart!
            </p>
            <Link
              to="/drops"
              className="text-blue-700 capitalize text-xl mt-5 hover:underline "
            >
              go to shopping page
            </Link>
          </div>
